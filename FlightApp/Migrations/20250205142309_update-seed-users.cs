    ...
    public partial class updateseedusers : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0de08c93-1b56-4a2a-a109-4d9ad2488c83", 0, "17cf0175-ff7e-4886-bf29-49d8792249f2", null, "customer@example.com", true, "Hello", 0, "Hello", false, null, "CUSTOMER@EXAMPLE.COM", "CUSTOMER@EXAMPLE.COM", "Password123!", "077123123123", false, null, "", false, "customer@example.com" },
                    { "b75a37fa-0945-4274-904b-aea3bfba5cdd", 0, "c17c7bab-c325-4b23-9ede-aae799b89c22", null, "admin@example.com", true, "Hello", 0, "Hello", false, null, "ADMIN@EXAMPLE.COM", "ADMIN@EXAMPLE.COM", "Password123!", "077123123123", false, null, "", false, "admin@example.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2", "0de08c93-1b56-4a2a-a109-4d9ad2488c83" },
                    { "1", "b75a37fa-0945-4274-904b-aea3bfba5cdd" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "Role", "UserId" },
                keyValues: new object[] { "2", "0de08c93-1b56-4a2a-a109-4d9ad2488c83" });

            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "Role", "UserId" },
                keyValues: new object[] { "1", "b75a37fa-0945-4274-904b-aea3bfba5cdd" });

            migrationBuilder.DeleteData(
                table: "AspNetUsers",
                keyColumn: "Id",
                keyValue: "0de08c93-1b56-4a2a-a109-4d9ad2488c83");

            migrationBuilder.DeleteData(
                table: "AspNetUsers",
                keyColumn: "Id",
                keyValue: "b75a37fa-0945-4274-904b-aea3bfba5cdd");
